...
**Tabel lengkap 82 route (rute → nama → agen → hub slug → theme): `docs/multiclaw-routes.md`.** Saat menambah/mengubah claw, update tabel di docs itu (bukan di sini).
